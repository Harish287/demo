  ...
  <div className="haircare">
      <div className="hair-div">
        ...
        <p>
          ...
          Whether your hair falls above or below your shoulders or whether you'd
          like a fringe cut or style change, our professional stylists are at
          hand to give you that head over heels effect.
        </p>
      </div>
      <div className="hair-div">
        <img src={hairimg} className="hair-img" alt="logo" />
      ...
      <div className="hair-div">
        ...
        <p>
          ...
          your own lovely locks. These services are all about crowning yourself
          with glory, so indulge to the fullest.
          <ul>
            <li>Hair Up Do</li>
          </ul>
        </p>
      ...
      <div className="hair-div">
        ...
        <p>
          ...
          services. You have a choice of everything from root and box root touch
          ups to global color, highlights, fashion streaks, henna and block
          coloring. Vote vibrant and usher some color into your life.
          <ul>
      ...
      <div className="hair-div">
        ...
        <p>
          ...
          stylists follow the hottest trends and use most reliable techniques to
          make spending time on yourself valuable
          <ul>
      ...
      <div className="hair-div">
        ...
        <p>
          ...
          well-trained in the art of threading. Hair around the eyebrows, upper
          lip, forehead, chin and jaw line will be easily done away with so you
          appear clean and fresh faced.
        </p>
      </div>
    </div>
    </div>
